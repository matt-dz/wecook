        ...
        "/api/recipes/{recipeID}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "JSON string containing recipe update data (UpdateRecipeFullData)",
                        "name": "data",
                        "in": "formData"
                    },
                    {
                    ...
                    {
                        "type": "file",
                        "description": "Image for ingredient at index (0-based)",
                        "name": "ingredient-{index}",
                        "in": "formData"
                    },
                    {
                        "type": "file",
                        "description": "Image for step at index (0-based)",
                        "name": "step-{index}",
                        "in": "formData"
                    }
                ],

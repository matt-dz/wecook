...
//
//	mockgen -source=internal/email/email.go -destination internal/email/emailmock.go -package email
//
...
func (mr *MockSenderMockRecorder) Send(to, subject, body any) *gomock.Call {
